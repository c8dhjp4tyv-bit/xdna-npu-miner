...
readonly artifact_dir="${build_dir}/xdna-smoke"
...
python "${root_dir}/src/xdna/smoke_program.py" \
    --dev npu \
    --xclbin-path "${artifact_dir}/xdna_smoke.xclbin" \
    --insts-path "${artifact_dir}/xdna_smoke.insts"

sha256sum \
    "${artifact_dir}/xdna_smoke.xclbin" \
    "${artifact_dir}/xdna_smoke.insts" \
